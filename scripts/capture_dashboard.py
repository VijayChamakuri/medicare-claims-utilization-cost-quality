...
PAGES = [("executive", "01_executive_overview.png"), ("utilization", "02_utilization_payment.png"),
         ("providers", "03_provider_operations.png"), ("quality", "04_quality_cohorts.png"),
         ("definitions", "05_data_quality_definitions.png")]
CANDIDATES = [
