...
| Real Tableau workbook with five checked dashboards and a Tableau Public URL | Met | `tableau/workbook/medicare_claims_bi.twbx` opens with no errors; 30 of 30 KPI tie-outs; all five dashboards inspected and fixed; Tableau screenshots in `tableau/screenshots/`; published at https://public.tableau.com/app/profile/vijay.chamakuri/viz/MedicareClaimsUtilizationPaymentQualityAnalyticsCMSDE-SynPUF/ExecutiveOverview. |
